...
if __name__ == '__main__':
    ...
    terms_list_long = [500, 1000, 1585, 2512, 4000, 6310, 10000, 15849, 25000, 50000, 100000, 250000]
    ...
    plt.plot(terms_list_long,
             time_values,
             marker="o")
    plt.title(f"Growth of Time Complexity in Iterative Approach for Fibonacci Series")
    plt.xlabel("n-th term")
    plt.ylabel("Time (s)")
    plt.grid(True)
    plt.show()

    pretty_table.add_column("n-th Term", terms_list_long)
    ...
    plt.plot(terms_list_long,
             time_values,
             marker="o")
    plt.title(f"Growth of Time Complexity in Dynamic Approach for Fibonacci Series")
    plt.xlabel("n-th term")
    plt.ylabel("Time (s)")
    plt.grid(True)
    plt.show()
